...
This minimal example shows the core v1.0 pattern: schema header, metadata, authority, roles, reading, block, section, ordo, proper, and teaching note. It includes translation variants (v1.1) to demonstrate multi-rendering support.

```json
{
  "$schema": "https://ols.otyg.org/schema/v1.1/corpus.schema.json",
  "ols_version": "1.1.0",
  "type": "corpus",
      ...
      "elements": [
        {
          "utterance": {
            ...
            "variants": {
              "en": [
                { "value": "Lord, have mercy.", "label": "EOTC Official", "source": "EOTC English Missal 2019", "default": true },
                { "value": "O Lord, show mercy.", "label": "Diaspora Prayer Book", "source": "St. Mary Cathedral, LA, 2021" },
                { "value": "Lord, be merciful to us.", "label": "Scholarly Literal", "source": "Getatchew Haile, CSCO vol. 542", "register": "scholarly" }
              ]
            }
          }
        },
