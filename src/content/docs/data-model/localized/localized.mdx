...
<Callout type="info">
A single language may have more than one accepted translation. See [Translation Variants](/liturgical-elements/data-model/translation-variants) for multi-variant support within a language.
</Callout>
